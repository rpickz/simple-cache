...
END
curl localhost:8080/debug/pprof/profile --output get_cpu_profile.prof &
...
END
curl localhost:8080/debug/pprof/profile --output put_cpu_profile.prof &
...
END
curl localhost:8080/debug/pprof/profile --output del_cpu_profile.prof &
